...
StaticSingleThreadedExecutor::spin()
{
  ...
  while (rclcpp::ok(this->context_) && spinning.load()) {
    ...
    number_of_ready=get_number_of_ready();
...
int
StaticSingleThreadedExecutor::get_number_of_ready()
{
  size_t numSub=wait_set_.size_of_subscriptions;
  size_t numTime=wait_set_.size_of_timers;
  size_t sum=numSub+numTime;
  return sum;
}